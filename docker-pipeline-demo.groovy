node {
    ...
    maven32.pull()
    // We are pushing to a public docker registry in this demo.
    // 'docker-hub-login' is the username/password credentials ID
    // as defined in Jenkins Credentials.
    // This is used to authenticate the docker client to the public docker registry.
